...
-- CreateIndex
CREATE INDEX "AIRecommendation_user_id_score_idx" ON "AIRecommendation"("user_id", "score");

-- CreateIndex
CREATE INDEX "AIRecommendation_created_at_idx" ON "AIRecommendation"("created_at");

-- CreateIndex
CREATE INDEX "InventoryPrediction_item_id_prediction_date_idx" ON "InventoryPrediction"("item_id", "prediction_date");

-- CreateIndex
CREATE INDEX "DemandForecast_forecast_date_idx" ON "DemandForecast"("forecast_date");

-- CreateIndex
CREATE INDEX "DemandForecast_menu_item_id_idx" ON "DemandForecast"("menu_item_id");

-- CreateIndex
CREATE INDEX "AIInsight_type_created_at_idx" ON "AIInsight"("type", "created_at");
...
-- AddForeignKey
ALTER TABLE "AIRecommendation" ADD CONSTRAINT "AIRecommendation_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AIRecommendation" ADD CONSTRAINT "AIRecommendation_menu_item_id_fkey" FOREIGN KEY ("menu_item_id") REFERENCES "MenuItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InventoryPrediction" ADD CONSTRAINT "InventoryPrediction_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "InventoryItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DemandForecast" ADD CONSTRAINT "DemandForecast_menu_item_id_fkey" FOREIGN KEY ("menu_item_id") REFERENCES "MenuItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
